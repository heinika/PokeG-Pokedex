...
class HeaderItemDelegate(private val onSettingClick: () -> Unit) : ItemViewDelegate<Header, HeaderItemDelegate.ViewHolder>() {
  ...
  override fun onCreateViewHolder(context: Context, parent: ViewGroup): ViewHolder {
    return ViewHolder(HeaderView(context,onSettingClick))
  }
